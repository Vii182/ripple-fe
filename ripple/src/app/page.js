                ...
                <div className="mt-4 text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-400 max-w-4xl mx-auto px-4">
                    <p className="text-center">
                        <span className="font-semibold text-primary-500">
                            Welcome to Ripple, the platform designed to connect
                            people, empower communities, and make a positive
                            impact.
                        </span>
                        <br />
                    </p>
                    ...
                    {isOpen && (
                        <p className="text-center mt-4">
                            By participating in the Ripple community, you can
                            donate items you no longer need, give back to those
                            in your area, and help support others through a
                            network of sharing. Whether you have electronic
                            goods, clothing, old toys or books to offer, Ripple
                            makes it easy to get involved and make a difference.
                            Join us today, and start contributing to a more
                            sustainable and caring world. Every donation
                            matters!
                        </p>
                    )}
                </div>
