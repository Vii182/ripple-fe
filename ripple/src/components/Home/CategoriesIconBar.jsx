...
const categories = [
  { name: "Electronics", icon: <LuCircuitBoard size={42}/>, slug: "electronics" },
  { name: "Home", icon: <IoHomeOutline size={42}/>, slug: "home" },
  { name: "Fashion", icon: <GiClothes size={42}/>, slug: "fashion" },
  { name: "Sports", icon: <MdOutlineSportsBaseball size={42}/>, slug: "sports" },
  { name: "Books", icon: <IoBookSharp size={42}/>, slug: "books" },
  { name: "Toys", icon: <MdSmartToy size={42}/>, slug: "toys" },
  { name: "Health", icon: <MdOutlineHealthAndSafety size={42}/>, slug: "health" },
  { name: "Groceries", icon: <PiBowlFoodBold size={42}/>, slug: "groceries" },
