...
const ItemForm = ({ onSubmit, user }) => {
    ...
    const labelStyle =
        "block font-medium font-Quicksand font-semibold text-textPrimary-light dark:text-textPrimary-dark mb-1";
        ...
        >
            <div>
                ...
                <input
                    ...
                    className="w-full px-3 py-2 rounded-md border text-black dark:border-textPrimary-light  dark:bg-gray-500 dark:text-textPrimary-dark"
                    required
                />
            </div>
            ...
            <div>
                ...
                <select
                    ...
                    onChange={handleChange}
                    className="w-full px-3 py-2 border text-black rounded-md dark:border-textPrimary-light  dark:bg-gray-500 dark:text-textPrimary-dark"
                    required
                >
            ...
            <div>
                <label htmlFor="image_url" className={labelStyle}>
                    IMAGE URL
                </label>
                <input
                    type="url"
            ...
            <div>
                <label htmlFor="collection_point" className={labelStyle}>
                    COLLECTION POINT
                </label>
                <input
                    type="text"
            ...
            <div>
                <label htmlFor="date_of_expire" className={labelStyle}>
                    EXPIRY DATE (IF ANY)
                </label>
                <input
                    type="datetime-local"
